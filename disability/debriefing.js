define(['questAPI'], function(Quest){
	...
	var info = '<p><h1 style="text-align:center; font-size:xx-large;font-weight: normal;"><b>You have completed the study.</b></h1></p><br/>' +
		...
		'<br/><p>Please note that these results were obtained with a previous version of the task that did not distinguish between different forms of disability. ' +
		'Currently, we are developing new versions of the task focusing on forms of disability other than physical disability (e.g., learning disability or mental illness).</p>' +
